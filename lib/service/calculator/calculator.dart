...
import 'package:calculator_lexemes/service/calculator/lexeme_buffer.dart';
...
class Calculator {
  ...
  Calculator(this._expressionText, [this._variables]);

  @override
  String toString() {
    return 'Calculator{expressionText: $_expressionText, variables: $_variables}';
  }
